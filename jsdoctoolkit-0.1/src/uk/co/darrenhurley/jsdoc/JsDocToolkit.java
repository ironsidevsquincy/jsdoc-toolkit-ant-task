 ...
 *  		classname="uk.co.darrenhurley.jsdoc.JSDocToolkit"
...
package uk.co.darrenhurley.jsdoc;
...
public class JsDocToolkit extends Task {
	...
	// optional properties
	private String encoding = "UTF-8", extensions = "js", config = "", log = "", inputDir = "";
	private int depth = -1;
	private boolean isUnderscoredFunctions = false, isUndocumentedFunctions = false, isPrivate = false, isVerbose = false;
     ...
     * 
     * @param jsDocHome a string of the path to the home directory of the
     * jsdoctoolkit.
     */
    ...
    /**
     * Compulsory attribute template, the name of the template to use (e.g. sunny, 
     * sweet, etc).
     * 
     * @param template a string of the name of the template to use
     */
     ...
     * 
     * @param outputDir a string of the path to where the genrated docs are placed
     */
     ...
     * 
     * @param inputDir a String of the path to the directory containing the 
     * files.
     */
     ...
     * 
     * @param encoding a string of the encoding to use
     */
     ...
     * 
     * @param isUndocumentedFunctions a boolean value of whether to show 
     * undocumented functions or not.
     */
     ...
     * 
     * @param isUnderscoredFunctions a boolean value of whether to show 
     * underscored functions or not
     */
     ...
     * private functions.
     * 
     * @param isPrivate a boolean value of whether to show private functions 
     * or not
     */
     ...
     * 
     * @param isVerbose a boolean value, setting whether to be verbose
     */
     ...
     * to js.
     * 
     * @param extensions a string of comma seperated extensions to include
     */
     ...
     * 
     * @param config a string of the path to the config file
     */
     ...
     * 
     * @param log a string of the path to the log file
     */
